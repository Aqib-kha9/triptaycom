...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fcfcfc] p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[120px] -translate-x-1/2 translate-y-1/2" />
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <p className="mt-12 text-zinc-400 text-xs text-center max-w-xs">
          By continuing, you agree to Triptay's <Link href="/terms" className="underline">Terms of Service</Link> and <Link href="/privacy" className="underline">Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
