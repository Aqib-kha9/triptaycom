...
const MY_ACTIVITIES = [
  {
    ...
    bookings: 24,
    rating: 4.8,
    image: "https://images.unsplash.com/photo-1530608139174-0675e8439b4c?auto=format&fit=crop&q=80&w=300"
  }
];
...
export default function VendorActivitiesPage() {
  ...
  const filtered = MY_ACTIVITIES.filter(l => l.title.toLowerCase().includes(search.toLowerCase()));
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-grow space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-1">
                <div>
                  <h1 className="text-xl font-bold text-zinc-900">My Activities</h1>
                  <p className="text-xs text-zinc-500 font-medium italic">Manage your experiences.</p>
                </div>
                  ...
                  <div key={listing.id} className="p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-6 hover:bg-zinc-50/50 transition-colors group">
                    <div className="flex items-center gap-5 w-full sm:w-auto">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs font-black text-zinc-400 italic">{listing.price}<span className="text-[10px] not-italic ml-1">/person</span></p>
                      </div>
                    </div>
          ...
          <div className="fixed inset-0 z-[150] flex items-center justify-center p-6">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }} className="relative w-full max-w-sm bg-white rounded-2xl p-8 space-y-6">
              ...
              <div className="text-center space-y-1">
                <h3 className="text-lg font-bold text-zinc-900">Delete Activity?</h3>
