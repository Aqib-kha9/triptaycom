...
const NOTIFICATIONS = [
  { id: 1, type: "booking", title: "New Booking Request", desc: "Aryan Singh sent a request for Mountain Whisper Villa (12-15 Oct).", time: "2m ago", unread: true, icon: <Calendar className="w-4 h-4" />, color: "bg-indigo-50 text-indigo-600", link: "/vendor/bookings" },
  { id: 2, type: "finance", title: "Payout Successful", desc: "Your payout of ₹24,500 has been processed to HDFC Bank.", time: "1h ago", unread: true, icon: <DollarSign className="w-4 h-4" />, color: "bg-emerald-50 text-emerald-600", link: "/vendor/earnings" },
  { id: 3, type: "message", title: "New Message from Meera", desc: "\"Thank you for the rafting tip! We are very excited.\"", time: "3h ago", unread: false, icon: <MessageSquare className="w-4 h-4" />, color: "bg-amber-50 text-amber-600", link: "/vendor/messages" },
];
